-- ❤️ https://www.youtube.com/watch?v=S-xzYgTLVJE
return {
	{
	...
	},
	{
		...
		config = function()
			...
			---------------------------------------------------------------------------
			-- LSP attach: bordered hover + on-demand diagnostic float (CUSTOM - CHATGPT)
			---------------------------------------------------------------------------
				...
				callback = function(args)
					...
					local function bordered_hover()
						...
						vim.lsp.buf_request(0, "textDocument/hover", params, function(err, result)
							...
							local _, win =
								vim.lsp.util.open_floating_preview(cleaned, "markdown", { border = "single" })
